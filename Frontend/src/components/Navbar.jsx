...
function Navbar() {
  ...
  return (
    <>
    <div className={`max-w-screen mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        sticky?"sticky-navbar shadow-md bg-red-800 dark:bg-slate-800 dark:text-white duration-300 transition-all ease-in-out"
        :""
    } `}>
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 bg-white">
      {Navbar}
      </ul>
    </div>
  ...
  
{
  authUser ? <Logout/> :
<div>
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-green-800 duration-300 cursor-pointer"
    onClick={()=>
